...
export class MyMigrations1728269116580 implements MigrationInterface {
    name = 'MyMigrations1728269116580'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "songs" ADD CONSTRAINT "FK_54cf41bc33d524b206b93581950" FOREIGN KEY ("playListId") REFERENCES "playlist"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
